        ...
        <Flex direction="col" justify="justify-between" className="py-20">
          <Flex direction="col" directionMd="col" align="start" className="md:w-1/2 pb-10">
            ...
            <p className="text-justify md:text-left">
              ...
              di Indonesia, untuk industri minyak, petrokimia, pembangkit listrik, kelautan, logam dan metalurgi. PT. RAKATA HEAT siap dan antusias untuk dapat bekerja sama dengan anda untuk mendukung
              kesuksesan anda. Kami siap di darat, laut dan hutan. Dari mulai kota besar hingga pelosok.
            </p>
          </Flex>
          <Flex justify="justify-end" className="w-full md:w-1/2 pt-16 relative max-w-screen-sm">
