...
const ContactUsSection: FC = () => {
  return (
    <section className="w-full bg-neutral-100">
      <Container>
        <Flex direction="col" justify="justify-center" gap="gap-10" className="py-32">
          ...
          <Flex justify="justify-between" className="bg-white p-6 border shadow-lg rounded-lg w-full max-w-sm hover:scale-110 duration-200">
            <Flex direction="col" directionMd="col" gap="gap-1" align="start">
